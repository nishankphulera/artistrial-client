...
import { InvestorSearchFilters } from '@/components/shared/InvestorSearchFilters';
...
import { FilterSidebar, FilterConfig as FilterSidebarConfig } from '@/components/shared/FilterSidebar';
import {
  useInvestorData,
  InvestorProfile,
  InvestorFilters,
  investorFilterConfig
} from '@/components/shared/data/InvestorDataService';
...
export default function InvestorsPage({ isDashboardDarkMode = false }: InvestorsPageProps) {
  ...
  const [investorFilters, setInvestorFilters] = useState<any>({
    searchTerm: '',
    category: [],
    subcategory: [],
    location: 'all',
  ...
  const filterConfig: FilterSidebarConfig = investorFilterConfig as any;
                  ...
                  <Card key={project.id} className="hover:shadow-lg transition-shadow">
                    ...
                    <CardHeader>
                      ...
                      <p className="text-sm text-muted-foreground">
                        <UserProfileLink 
                          userId={(project as any).creator_id || project.id}
