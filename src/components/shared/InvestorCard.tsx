          ...
          <div className="flex items-start justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-muted-foreground">{(formattedInvestor as any).company || formattedInvestor.type}</p>
            ...
            <div className="flex items-center gap-2">
              <FavoritesButton
                ...
                size="sm"
              />
              <Badge variant={(formattedInvestor as any).isActive ? 'default' : 'secondary'}>
                {(formattedInvestor as any).isActive ? 'Active' : 'Inactive'}
              </Badge>
              {/* Admin Actions */}
              {adminActions && (formattedInvestor as any).isOwner && (
          ...
          <div className="space-y-4">
            ...
            {formattedInvestor.rating && (
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm">{formattedInvestor.rating.toFixed(1)} ({(formattedInvestor as any).total_reviews || 0} reviews)</span>
              </div>
            )}
            ...
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div className="flex items-center">
                ...
                <span>{(formattedInvestor as any).investmentRange}</span>
              </div>
              <div className="flex items-center">
                <TrendingUp className="h-4 w-4 mr-2 text-blue-600" />
                <span>{(formattedInvestor as any).totalFunding}</span>
              </div>
              <div className="flex items-center">
                <Building className="h-4 w-4 mr-2 text-purple-600" />
                <span>{(formattedInvestor as any).previousInvestments} investments</span>
              </div>
              <div className="flex items-center">
            ...
            <p className="text-sm text-muted-foreground line-clamp-2">
              {(formattedInvestor as any).description}
            </p>
