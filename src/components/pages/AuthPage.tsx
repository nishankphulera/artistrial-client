...
//     if (mode === "signup") {
//       if (!formData.fullName || !formData.username || !formData.profileType) {
//         toast.error("Please fill in all required fields");
//         return false;
//       }
...
//             {mode === "signin" ? "Welcome back" : "Join Artistrial"}
//           </h2>
...
//                       </SelectTrigger>
//                       <SelectContent>
//                         <SelectItem value="Artist">Artist - Create and sell artwork</SelectItem>
//                         <SelectItem value="Venue">Venue - Rent out studio/gallery space</SelectItem>
//                         <SelectItem value="Investor">Investor - Fund creative projects</SelectItem>
//                         <SelectItem value="Legal">Legal - Provide legal services</SelectItem>
//                       </SelectContent>
//                     </Select>
...
//                 <button onClick={switchMode} className="font-medium text-purple-600 hover:text-purple-500">
