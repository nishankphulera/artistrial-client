                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <Card className={`group cursor-pointer transition-all hover:shadow-xl ${isDashboardDarkMode ? "bg-gray-800 border-gray-600" : "bg-white border-gray-200"}`}>
                      <div className="aspect-square relative overflow-hidden">
                        <div className="grid grid-cols-2 gap-1 h-full">
                          <ImageWithFallback
                            src="https://images.unsplash.com/photo-1471195661661-94b8ad79f3c3"
                            alt="Urban Life 1"
                            className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                          />
                          <ImageWithFallback
                      ...
                      <CardContent className="p-6">
                        ...
                        <p className={`text-sm mb-4 leading-relaxed ${isDashboardDarkMode ? "text-gray-300" : "text-gray-700"}`}>
                          A photo series documenting the diverse faces and places that make our city unique. Each frame captures a moment of authentic human experience.
                        </p>
                        <div className="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-700">
                          <div className="flex items-center gap-6">
                            <div className="flex items-center gap-2">
                    ...
                    <Card className={`group cursor-pointer transition-all hover:shadow-xl ${isDashboardDarkMode ? "bg-gray-800 border-gray-600" : "bg-white border-gray-200"}`} onClick={handlePlayAudio}>
                      <div className="aspect-square relative overflow-hidden bg-gradient-to-br from-orange-500 to-red-500 flex items-center justify-center">
                        <div className="text-center text-white">
                          <div className="w-20 h-20 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
                            <Music className="w-10 h-10" />
                          </div>
                          <h3 className="font-title text-xl font-bold mb-2">Ambient Dreams</h3>
                      ...
                      <CardContent className="p-6">
                        ...
                        <p className={`text-sm mb-4 leading-relaxed ${isDashboardDarkMode ? "text-gray-300" : "text-gray-700"}`}>
                          An original ambient soundscape created for meditation and deep focus. Layered textures and organic sounds blend to create a peaceful sonic journey.
                        </p>
                        <div className="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-700">
                          <div className="flex items-center gap-6">
                            <div className="flex items-center gap-2">
                    ...
                    <Card className={`group cursor-pointer transition-all hover:shadow-xl ${isDashboardDarkMode ? "bg-gray-800 border-gray-600" : "bg-white border-gray-200"}`}>
                      ...
                      <CardContent className="p-6">
                        ...
                        <p className={`text-sm mb-4 leading-relaxed ${isDashboardDarkMode ? "text-gray-300" : "text-gray-700"}`}>
                          Watch the creative process unfold in real-time as a new piece comes to life. From blank canvas to finished artwork in 2.5 minutes!
                        </p>
                        <div className="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-700">
                          <div className="flex items-center gap-6">
                            <div className="flex items-center gap-2">
