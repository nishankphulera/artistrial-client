...
import { DASHBOARD_ROUTES, CREATE_ROUTES, LEADS_ROUTES, BUSINESS_ROUTES } from '../../utils/routes';
...
export function DashboardRoutes({ onAddToCart, cartItemCount, onProceedToCheckout }: DashboardRoutesProps) {
  const { user } = useAuth();
