...
export const CreateListingPage: React.FC<CreateListingPageProps> = ({ isDashboardDarkMode = false }) => {
  ...
  const renderForm = () => {
    switch (selectedType) {
      case 'talent':
        return <TalentListingForm onClose={handleFormClose} isDashboardDarkMode={isDashboardDarkMode} />;
      case 'asset':
      ...
      case 'investor':
        return <InvestorListingForm onClose={handleFormClose} isDashboardDarkMode={isDashboardDarkMode} />;
      case 'ticket':
        return <TicketListingForm onClose={handleFormClose} isDashboardDarkMode={isDashboardDarkMode} />;
      case 'legal':
        return <LegalListingForm onClose={handleFormClose} isDashboardDarkMode={isDashboardDarkMode} />;
      case 'product_service':
        return <ProductServicesListingForm onClose={handleFormClose} isDashboardDarkMode={isDashboardDarkMode} />;
      case 'education':
        return <EducationListingForm onClose={handleFormClose} isDashboardDarkMode={isDashboardDarkMode} />;
      default:
        return null;
    }
  };
